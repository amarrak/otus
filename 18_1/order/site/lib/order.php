	...
	implements Kernel\Errorable
{
	...
	private static $availableFields = ["user_id", "price"];
	...
	public function add(array $data) : int
	{
		...
		$sql = 'INSERT INTO b_order('.$subSql1.') VALUES('.$subSql2.')';
	...
	public function update($id, array $data) : int
	{
		...
		$sql = 'UPDATE b_order SET '.$subSql.' where ID = :id';
		$subValues[":id"] = $id;
	...
	public function delete($id) : int
	{
		...
		$sql = 'DELETE FROM b_order where ID = :id';
		$subValues[":id"] = $id;
